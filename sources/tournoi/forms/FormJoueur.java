...
/**
 *  La fenêtre qui permet de saisir des joueurs.
 */
public class FormJoueur extends JInternalFrame implements Observer, TableModelListener
{
	...
	private JLabel lblListeJoueurs = new JLabel("Liste des joueurs de la compétition");
	...
	private JButton bSauverSelection = new JButton("Enregistrer sélection");
	private JButton bImprimerPresents = new JButton("Imprimer joueurs présents");
	...
	/**
	 *  écoute les chagenement du radio button licencie
	 *
	 * @param  e  l'évènement déclenché
	 */
	...
	/**
	 *  Modifie les caractéristique d'un joueurs
	 *
	 * @param  e  Description of the Parameter
	 */
	 ...
	 *
	 * @return    le joueur fabrique ou null si les champs étaient invalid
	 */
	...
	/**
	 *  Sauvegarde les joueurs présents dans le tournois
	 *
	 * @param  e  Description of the Parameter
	 */
	...
	private void imprimerPresents(ActionEvent e)
	{
		PrintJob pJob = getToolkit().getPrintJob(new Frame(),
					 "Imprimer_Joueurs_Présents", null);
		if(pJob==null) return;	
	...
	public void actionKeyPressed(KeyEvent e)
	{
		...
		{
			// rechercher l'index du premier joueur dont le nom commence par la lettre tapée
			int index = 0;
			for(int x=0; x<tableJoueurs.getRowCount(); x++)
			{
