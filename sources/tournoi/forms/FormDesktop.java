...
public class FormDesktop extends JFrame
{
	...
	JMenu menuCompetition = new JMenu("Compétition");	
	...
	JMenu menu = new JMenu("Affichage");
		menu.getAccessibleContext().setAccessibleDescription(
			"Pour afficher ou cacher des fenêtre.");
	...
	// menu affichage joueur
		...
		JCheckBoxMenuItem menuJoueur = new JCheckBoxMenuItem("Fenêtre joueurs",false);			
		menuJoueur.getAccessibleContext().setAccessibleDescription(
			"Affiche ou cache la fenêtre des joueurs");

		JCheckBoxMenuItem menuFormules = new JCheckBoxMenuItem("Fenêtre des formules",false);			
		menuJoueur.getAccessibleContext().setAccessibleDescription(
			"Affiche ou cache la fenêtre pour créer vos formules");


		JCheckBoxMenuItem menuTables = new JCheckBoxMenuItem("Fenêtre tables libres",false);			
		menuTables.getAccessibleContext().setAccessibleDescription(
			"Affiche ou cache la fenêtre des tables libres");
		...
		menuDossard.getAccessibleContext().setAccessibleDescription(
			"Affiche ou cache les numéros de dossards des joueurs");
	...
	JCheckBoxMenuItem menuTournoi = new JCheckBoxMenuItem("Fenêtre tournois",false);			
		menuJoueur.getAccessibleContext().setAccessibleDescription(
			"Affiche ou cache la fenêtre des tournois");
